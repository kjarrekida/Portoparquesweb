...
export default function PodaPublica() {
    ...
    const validate = () => {
        ...
        if (!turnstileToken) {
            e.turnstile = 'Complete la verificación de seguridad'
        }
                            ...
                            {submitted ? (
                                ...
                                <>
                                    ...
                                    <form className="poda__form" onSubmit={handleSubmit} noValidate>
                                        ...
                                        <div className={`poda__field ${errors.turnstile ? 'poda__field--error' : ''}`} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '1rem' }}>
                                            <Turnstile 
                                                ...
                                                options={{ theme: 'dark' }}
                                            />
                                            {errors.turnstile && <span className="poda__error"><FaExclamationTriangle /> {errors.turnstile}</span>}
                                        </div>
